#
#  Be sure to run `pod spec lint JFAlertViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "JunFly" => "ijunfly@163.com" }
  ...
  s.source       = { :git => "https://github.com/ijunfly/JFAlertViewController.git", :tag => "#{s.version}" }
